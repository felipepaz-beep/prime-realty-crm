          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="sm:col-span-2">
                ...
                <FormControl>
                  <Input placeholder="Ex: Ligar para cliente, Visita ao imóvel..." {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="sm:col-span-2">
                ...
                <FormControl>
                  <Textarea placeholder="Detalhes da atividade..." rows={2} {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input placeholder="Endereço ou link de reunião..." {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
