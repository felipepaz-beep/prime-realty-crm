...
import {
  ...
  buscarAtividadesHoje,
  buscarClientesPrioritarios,
  buscarClientesRecentes,
  buscarFollowupsPendentes,
  buscarFunil,
  buscarIndicadores,
  buscarMetricas,
  pesquisarGlobal,
...
export function useFollowupsPendentes() {
  return useQuery({
    queryKey: dashboardKeys.followups(),
    queryFn: buscarFollowupsPendentes,
    staleTime: 30_000,
  });
}
export function useClientesRecentes() {
  return useQuery({
    ...
    queryFn: buscarClientesRecentes,
    staleTime: 60_000,
  });
}
export function useClientesPrioritarios() {
  return useQuery({
    queryKey: dashboardKeys.prioritarios(),
    queryFn: buscarClientesPrioritarios,
    staleTime: 60_000,
  });
}
export function useAtividadesHoje() {
  return useQuery({
    queryKey: dashboardKeys.atividadesHoje(),
    queryFn: buscarAtividadesHoje,
    staleTime: 30_000,
  });
}
export function useAtividadesDoDia() {
  return useQuery({
    queryKey: dashboardKeys.atividadesDia(),
    queryFn: buscarAtividadesDoDia,
    staleTime: 30_000,
  });
}
export function useAtividadesAtrasadas() {
  return useQuery({
    queryKey: dashboardKeys.atividadesAtrasadas(),
    queryFn: buscarAtividadesAtrasadas,
    staleTime: 30_000,
  });
}
export function useIndicadores() {
  return useQuery({
    queryKey: dashboardKeys.indicadores(),
...
export function usePesquisaGlobal(termo: string) {
  return useQuery({
    queryKey: dashboardKeys.pesquisa(termo),
    queryFn: () => pesquisarGlobal(termo),
