...
export const AI_ACTION_LABELS: Record<AIAction, string> = {
  ...
  criar_whatsapp: "Criar WhatsApp",
  criar_email: "Criar e-mail",
  criar_followup: "Criar follow-up",
  criar_observacao: "Criar observação",
  criar_tarefa: "Criar tarefa",
  criar_proposta: "Criar proposta",
  criar_roteiro_visita: "Criar roteiro de visita",
  criar_anuncio: "Criar anúncio",
  criar_descricao_imovel: "Criar descrição do imóvel",
  resumir_timeline: "Resumir histórico",
  resumir_conversa: "Resumir conversa",
  analisar_cliente: "Analisar cliente",
  extrair_dados_documento: "Extrair dados do documento",
